class User < ApplicationRecord
     ...
     def after_save_handling
          raise ActiveRecord::RecordInvalid, "after_save"
     end 

     def before_save_handling
          raise ActiveRecord::RecordInvalid, "before_save_handling"
     end 

     def after_commit_handling
          raise ActiveRecord::RecordInvalid, "after_commit_handling"
     end 

     def after_create_handling 
          raise ActiveRecord::RecordInvalid, "after_create_handling"
     end 
end 